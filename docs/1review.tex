...
\begin{figure}[hbt]
    \includegraphics{http://www.torsten-horn.de/img/Scrum.png}
    \caption{Scrum Vorgehensmodell}
\end{figure}
...
Quelle: http://scrum-master.de/Was_ist_Scrum/Scrum_auf_einer_Seite_erklaert
